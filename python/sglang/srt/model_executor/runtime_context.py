...
class BufferSpec:
    """Metadata for a lazily-materialized buffer — shape/dtype/device, NOT the
    physical tensor (generated at get_buffer time, not pre-allocated)."""
